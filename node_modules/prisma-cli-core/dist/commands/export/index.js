                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (this.definition.definition.databaseType &&
                            ...
                            this.out.log(chalk_1.default.yellow("Warning: The `prisma1 export` command will not be further developed in the future. Please use the native export features of your database for these workflows. \n    \nMore info here:\nMySQL: https://dev.mysql.com/doc/refman/5.7/en/mysqlimport.html \nPostgres: https://www.postgresql.org/docs/10/app-pgrestore.html\n"));
                        }
                    ...
                    case 3:
                        _a.sent();
                        importCommand = chalk_1.default.green.bold("$ prisma1 import --data " + exportPath);
