    ...
    Deploy.prototype.printResult = function (payload, force, dryRun) {
        ...
        if (payload.warnings && payload.warnings.length > 0) {
            ...
            if (force) {
                ...
                this.out.log("\nIf you want to ignore the warnings, please deploy with the --force flag: " + chalk_1.default.cyan('$ prisma1 deploy --force'));
